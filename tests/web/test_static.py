...
def test_largefile(webapp) -> None:
...
def test_unsatisfiable_range1(webapp) -> None:
    connection = HTTPConnection(webapp.server.host, webapp.server.port)
