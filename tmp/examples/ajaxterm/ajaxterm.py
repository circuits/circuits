...
An AJAX Terminal based on the popular Ajaxterm but using the circuits.web
framework.
"""
...
from circuits.web import Controller, Server, Sessions, Static
...
class SynchronizedMethod(object):
    ...
    def __init__(self,lock,orig):
        super(SynchronizedMethod, self).__init__()
