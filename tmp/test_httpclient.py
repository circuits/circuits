...
class Client(BaseComponent):
    ...
    def __init__(self, bind=None, **kwargs):
        ...
        kwargs["channel"] = kwargs.get("channel", Client.channel)

        self._client = TCPClient(bind, **kwargs)
        self += self._client
    ...
    def status(self):
        ...
        self._status = version, status, reason
        return self._status
...
m.push(Connect("www.google.com", 80))
